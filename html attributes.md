...
### 1️⃣ href
Used in anchor (<a>) tag to define link destination.
...
### 2️⃣ src
Used to define the source of an image, video, etc.
...
### 4️⃣ class
Used for secting elements in CSS.
